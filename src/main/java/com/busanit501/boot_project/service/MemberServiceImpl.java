...
public class MemberServiceImpl implements MemberService {
    ...
    private final ModelMapper modelMapper; // dto<->entity 타입 변환
    private final MemberRepository memberRepository; // 디비에 로직처리하는 도구CRUD
    private final PasswordEncoder  passwordEncoder; // 평문의 패스워드 -> 암호화시켜주는 도구

    @Override
    public void join(MemberJoinDTO memberJoinDTO) throws MidExistException {

        //1. 회원가입하는 아이디가 존재하는지 확인
